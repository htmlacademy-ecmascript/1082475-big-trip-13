...
/* harmony import */ var _model_points__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./model/points */ "./src/model/points.js");
/* harmony import */ var _model_offers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./model/offers */ "./src/model/offers.js");
/* harmony import */ var _model_destinations__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./model/destinations */ "./src/model/destinations.js");
...
class Api {
  ...
  getPoints() {
    return this._load({url: `points`})
      .then(Api.toJSON)
      .then((points) => points.map(_model_points__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient));
  }
  ...
  updatePoint(point) {
    return this._load({
      url: `points/${point.id}`,
      method: Method.PUT,
      body: JSON.stringify(_model_points__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer(point)),
      headers: new Headers({"Content-Type": `application/json`})
    })
      .then(Api.toJSON)
      .then(_model_points__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient);
  }

  getOffers() {
    return this._load({url: `offers`})
      .then(Api.toJSON)
      .then((offers) => offers.map(_model_offers__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToClient));
  }

  getDestinations() {
    return this._load({url: `destinations`})
      .then(Api.toJSON)
      .then((destinations) => destinations.map(_model_destinations__WEBPACK_IMPORTED_MODULE_2__["default"].adaptToClient));
  }
...
/* harmony import */ var _mock_info__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./mock/info */ "./src/mock/info.js");
/* harmony import */ var _mock_sorting__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./mock/sorting */ "./src/mock/sorting.js");
/* harmony import */ var _presenter_trip__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./presenter/trip */ "./src/presenter/trip.js");
/* harmony import */ var _presenter_controls__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./presenter/controls */ "./src/presenter/controls.js");
...
const info = Object(_mock_info__WEBPACK_IMPORTED_MODULE_1__["generateInfo"])();
...
const sorting = Object(_mock_sorting__WEBPACK_IMPORTED_MODULE_2__["generateSorting"])();
const api = new _api__WEBPACK_IMPORTED_MODULE_10__["default"](END_POINT, AUTHORIZATION);
...
const tripPresenter = new _presenter_trip__WEBPACK_IMPORTED_MODULE_3__["default"](pointsContainer, pointsModel, sorting, filterModel, offersModel, destinationsModel, api);
const controlPresenter = new _presenter_controls__WEBPACK_IMPORTED_MODULE_4__["default"](tripContainer, filterModel, pointsModel);
...
api.getPoints()
  .then((points) => {
    pointsModel.setPoints(_const__WEBPACK_IMPORTED_MODULE_11__["UpdateType"].INIT, points);
  })
  .catch(() => {
    pointsModel.setPoints(_const__WEBPACK_IMPORTED_MODULE_11__["UpdateType"].INIT, []);
  });

api.getOffers()
  .then((offers) => {
    offersModel.setOffers(_const__WEBPACK_IMPORTED_MODULE_11__["UpdateType"].INIT, offers);
  })
  .catch(() => {
    offersModel.setOffers(_const__WEBPACK_IMPORTED_MODULE_11__["UpdateType"].INIT, []);
  });

api.getDestinations()
  .then((destinations) => {
    destinationsModel.setDestinations(_const__WEBPACK_IMPORTED_MODULE_11__["UpdateType"].INIT, destinations);
  })
  .catch(() => {
    destinationsModel.setDestinations(_const__WEBPACK_IMPORTED_MODULE_11__["UpdateType"].INIT, []);
  });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Destinations; });
/* harmony import */ var _utils_observer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/observer */ "./src/utils/observer.js");


class Destinations extends _utils_observer__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
    this._destinations = [];
  }
...
class Offers extends _utils_observer__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
    this._offers = [];
  }
  ...
  static adaptToClient(point) {
    ...
    const adaptedPoint = Object.assign(
        ...
        point,
        {
          ...
          dateTimeStartEvent: dayjs__WEBPACK_IMPORTED_MODULE_2___default()(point.date_from),
          dateTimeEndEvent: dayjs__WEBPACK_IMPORTED_MODULE_2___default()(point.date_to),
  ...
  static adaptToServer(point) {
    ...
    const adaptedPoint = Object.assign(
        ...
        point,
        {
          ...
          'date_from': point.dateTimeStartEvent instanceof dayjs__WEBPACK_IMPORTED_MODULE_2___default.a ? point.dateTimeStartEvent.toISOString() : null,
          'date_to': point.dateTimeEndEvent instanceof dayjs__WEBPACK_IMPORTED_MODULE_2___default.a ? point.dateTimeEndEvent.toISOString() : null,
          'destination': {
...
class Point {
  ...
  init(point, offers, destinations) {
    ...
    this._pointEditComponent = new _view_point_edit__WEBPACK_IMPORTED_MODULE_1__["default"](point, this._offers, this._destinations);
...
/* harmony import */ var _view_loading__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/loading */ "./src/view/loading.js");
/* harmony import */ var _view_no_point__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../view/no-point */ "./src/view/no-point.js");
/* harmony import */ var _point__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./point */ "./src/presenter/point.js");
/* harmony import */ var _point_new__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./point-new */ "./src/presenter/point-new.js");
...
class Trip {
  constructor(tripContainer, pointsModel, sorting, filterModel, offersModel, destinationsModel, api) {
    ...
    this._loadingComponent = new _view_loading__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._noPointComponent = new _view_no_point__WEBPACK_IMPORTED_MODULE_3__["default"]();
    ...
    this._pointNewPresenter = new _point_new__WEBPACK_IMPORTED_MODULE_5__["default"](this._tripListComponent, this._onViewAction);
  }
  ...
  createPoint() {
    this._currentSortType = _const__WEBPACK_IMPORTED_MODULE_9__["SortType"].DEFAULT;
    this._filterModel.setFilter(_const__WEBPACK_IMPORTED_MODULE_9__["UpdateType"].MAJOR, _const__WEBPACK_IMPORTED_MODULE_9__["FilterType"].EVERYTHING);
  ...
  _getPoints() {
    ...
    const points = this._pointsModel.getPoints();
    const filteredPoints = _utils_filter__WEBPACK_IMPORTED_MODULE_8__["filter"][filterType](points);

    switch (this._currentSortType) {
      case _const__WEBPACK_IMPORTED_MODULE_9__["SortType"].DATE_OLDER:
        return filteredPoints.sort(_utils_point__WEBPACK_IMPORTED_MODULE_6__["sortPointOlder"]);
      case _const__WEBPACK_IMPORTED_MODULE_9__["SortType"].DATE_NEWER:
        return filteredPoints.sort(_utils_point__WEBPACK_IMPORTED_MODULE_6__["sortPointNewer"]);
      // todo default
    }
  ...
  _onViewAction(actionType, updateType, update) {
    switch (actionType) {
      case _const__WEBPACK_IMPORTED_MODULE_9__["UserAction"].UPDATE_POINT:
        this._api.updatePoint(update)
          .then((response) => {
            this._pointsModel.updatePoint(updateType, response);
          });
        break;
      case _const__WEBPACK_IMPORTED_MODULE_9__["UserAction"].ADD_POINT:
        this._pointsModel.addPoint(updateType, update);
        break;
      case _const__WEBPACK_IMPORTED_MODULE_9__["UserAction"].DELETE_POINT:
  ...
  _onModelEvent(updateType, data) {
    ...
    switch (updateType) {
      ...
      case _const__WEBPACK_IMPORTED_MODULE_9__["UpdateType"].INIT:
        ...
        Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["remove"])(this._loadingComponent);
        // this._clearTrip();
        this._renderTrip();
        break;
      // todo default
  ...
  _renderSort() {
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["render"])(this._tripContainer, this._sortingComponent, _utils_render__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].BEFOREEND);
    // this._sortingComponent.setOnSortTypeChange(this._onSortTypeChange);
  }

  _renderPoint(point, offers, destinations) {
    const pointPresenter = new _point__WEBPACK_IMPORTED_MODULE_4__["default"](this._tripListComponent, this._onViewAction, this._onModeChange);
  ...
  _renderLoading() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["render"])(this._tripContainer, this._loadingComponent, _utils_render__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].AFTERBEGIN);
  }

  _renderNoPoints() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["render"])(this._tripContainer, this._noPointComponent, _utils_render__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].BEFOREEND);
  }
  ...
  _clearTrip({resetSortType = false} = {}) {
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["remove"])(this._sortingComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["remove"])(this._loadingComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["remove"])(this._noPointComponent);
  ...
  _renderTrip() {
    ...
    setTimeout(() => {
      ...
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_7__["render"])(this._tripContainer, this._tripListComponent, _utils_render__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].BEFOREEND);
...
const BLANK_POINT = {
  ...
  dateTimeStartEvent: dayjs__WEBPACK_IMPORTED_MODULE_1___default()(),
  dateTimeEndEvent: dayjs__WEBPACK_IMPORTED_MODULE_1___default()(),
  cost: 0,
  isFavorite: false,
};
