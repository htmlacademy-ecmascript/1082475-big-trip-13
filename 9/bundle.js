...
/*!***************************!*\
  !*** ./src/mock/point.js ***!
  \***************************/
/*! exports provided: generateOffers, generateDescription, generatePoint */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class PointEdit extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(point) {
    super();
    this._point = point;
    this._editForm = null;
  ...
  _onPointTypeChange(evt) {
    if (evt.target.matches(`input.event__type-input`)) {
      evt.preventDefault();
      const updatedPoint = this._point.offers = Object(_mock_point__WEBPACK_IMPORTED_MODULE_5__["generateOffers"])();
  ...
  _onDestinationChange(evt) {
    evt.preventDefault();
    const updatedPoint = this._point.destinationInfo[0].description = Object(_mock_point__WEBPACK_IMPORTED_MODULE_5__["generateDescription"])();
    this.updateData(updatedPoint);
  }
